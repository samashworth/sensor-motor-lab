...
*/
boolean DummySensor::initialize(int numPins, int pinIds[], int numInterrupts, int interruptIds[], String* errorMessage)
{
  return false;
}
...
*/
boolean DummySensor::doProcessing(String* errorMessage)
{
  return false;
}
