...
*/
boolean Thermistor::initialize(int numPins, int pinIds[], int numInterrupts, int interruptIds[], String* errorMessage)
{
...
*/
boolean Thermistor::doProcessing(String* errorMessage)
{
  // TODO @Erin: Implement this.
  return false;
}
