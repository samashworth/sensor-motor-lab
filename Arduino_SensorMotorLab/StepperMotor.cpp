...
*/
boolean StepperMotor::initialize(int numPins, int pinIds[], int numInterrupts, int interruptIds[], String* errorMessage)
{
...
*/
int StepperMotor::getMaxSpeedRPM()
{
  // TODO @Erin: Implement this.
  return 0;
}
...
*/
void StepperMotor::setSpeedRPM(int rpm)
{
  // TODO @Erin: Implement this.
}
...
*/
void StepperMotor::rotateDegrees(int deg)
{
  // TODO @Erin: Implement this.
}
...
*/
boolean StepperMotor::doProcessing(String* errorMessage)
{
  // TODO @Erin: Implement this.
  return false;
}
