...
*/
boolean RangeSensor::initialize(int numPins, int pinIds[], int numInterrupts, int interruptIds[], String* errorMessage)
{
...
*/
boolean RangeSensor::doProcessing(String* errorMessage)
{
  // TODO @Roger: Implement this.
  return false;
}
