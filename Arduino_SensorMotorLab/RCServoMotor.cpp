...
*/
boolean RCServoMotor::initialize(int numPins, int pinIds[], int numInterrupts, int interruptIds[], String* errorMessage)
{
...
*/
int RCServoMotor::getMaxSpeedRPM()
{
  // TODO @Roger: Implement this
  return 0;
}
...
*/
void RCServoMotor::setSpeedRPM(int rpm)
{
  // TODO @Roger: Implement this
}
...
*/
void RCServoMotor::rotateDegrees(int deg)
{
  // TODO @Roger: Implement this
}
...
*/
boolean RCServoMotor::doProcessing(String* errorMessage)
{
  // TODO @Roger: Implement this
  return false;
}
