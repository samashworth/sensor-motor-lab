...
*/
boolean DCMotor::initialize(int numPins, int pinIds[], int numInterrupts, int interruptIds[], String* errorMessage)
{
...
*/
void DCMotor::setSpeedRPM(int rpm)
{
  // TODO @Sonali: Implement this.  
}
...
*/
void DCMotor::rotateDegrees(int deg)
{
  // TODO @Sonali: Implement this.  
}
...
*/
boolean DCMotor::doProcessing(String* errorMessage)
{
  // TODO @Sonali: Implement this.  
  return false;
}
